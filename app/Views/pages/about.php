...
<section class="section shell about-grid">
    ...
    <ol class="process-list">
        ...
        <li><span>02</span><div><h3>Controller</h3><p>Defines a temporary static PHP array and sends it to the selected view.</p></div></li>
...
<section class="section shell values-grid">
    ...
    <article><strong>Data source</strong><p>Static PHP arrays</p></article>
