...
<section class="hero shell">
    ...
    <div class="hero-panel" aria-label="System overview">
        ...
        <div class="metric-grid">
            ...
            <article><span class="metric-icon">04</span><strong>100%</strong><small>Local data</small></article>
        </div>
    </div>
</section>
<section class="section shell">
    <div class="section-heading">
        <div><p class="eyebrow">Core workspace</p><h2>Everything needed for the first release</h2></div>
        <p>This version focuses on navigation, controller logic, reusable views, and static data before database integration.</p>
    </div>
